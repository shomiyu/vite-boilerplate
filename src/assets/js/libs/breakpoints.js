...
const deviceFunctionController = (currentDevice, functions) => {
  if (currentDevice === 'sp') {
    functions.pc && typeof functions.pc.remove === 'function'
      ? functions.pc.remove()
      : null;
    functions.tablet && typeof functions.tablet.remove === 'function'
      ? functions.tablet.remove()
      : null;
    functions.sp && typeof functions.sp.add === 'function'
      ? functions.sp.add()
      : null;
  }
  if (currentDevice === 'tablet') {
    functions.pc && typeof functions.pc.remove === 'function'
      ? functions.pc.remove()
      : null;
    functions.sp && typeof functions.sp.remove === 'function'
      ? functions.sp.remove()
      : null;
    functions.tablet && typeof functions.tablet.add === 'function'
      ? functions.tablet.add()
      : null;
  }
  if (currentDevice === 'pc') {
    functions.sp && typeof functions.sp.remove === 'function'
    ...
    functions.tablet && typeof functions.tablet.remove === 'function'
      ? functions.tablet.remove()
      : null;
    functions.pc && typeof functions.pc.add === 'function'
      ? functions.pc.add()
      : null;
  }
};
